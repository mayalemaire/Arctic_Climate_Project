...
gg_change_alaska <- ggplot() +
  geom_tile(data = subset(alaska_change, Absolute_diff <= -6), 
            aes(x = lon, y = lat), 
            fill = "#5698c5", width = 1, height = 1) +
  geom_tile(data = subset(alaska_change, Absolute_diff > -6 & Absolute_diff <= -3), 
            aes(x = lon, y = lat), 
            fill = "#a9cde3", width = 1, height = 1) +
  geom_tile(data = subset(alaska_change, Absolute_diff > -3 & Absolute_diff <= -0), 
            aes(x = lon, y = lat), 
            fill = "#e0f2fe", width = 1, height = 1) +
  geom_tile(data = subset(alaska_change, Absolute_diff > 0 & Absolute_diff <= 3), 
            aes(x = lon, y = lat), 
            fill = "#feddcc", width = 1, height = 1) +
  geom_tile(data = subset(alaska_change, Absolute_diff > 3 & Absolute_diff <= 6), 
            aes(x = lon, y = lat), 
...
gg_change_northern_fennoscandia <- ggplot() +
  geom_tile(data = subset(northern_fennoscandia_change, Absolute_diff <= -6), 
            aes(x = lon, y = lat), 
            fill = "#5698c5", width = 1, height = 1) +
  geom_tile(data = subset(northern_fennoscandia_change, Absolute_diff > -6 & Absolute_diff <= -3), 
            aes(x = lon, y = lat), 
            fill = "#a9cde3", width = 1, height = 1) +
  geom_tile(data = subset(northern_fennoscandia_change, Absolute_diff > -3 & Absolute_diff <= -0), 
            aes(x = lon, y = lat), 
            fill = "#e0f2fe", width = 1, height = 1) +
  geom_tile(data = subset(northern_fennoscandia_change, Absolute_diff > 0 & Absolute_diff <= 3), 
            aes(x = lon, y = lat), 
            fill = "#feddcc", width = 1, height = 1) +
  geom_tile(data = subset(northern_fennoscandia_change, Absolute_diff > 3 & Absolute_diff <= 6), 
            aes(x = lon, y = lat), 
            fill = "#e6795a", width = 1, height = 1) +
  geom_tile(data = subset(northern_fennoscandia_change, Absolute_diff > 6), 
            aes(x = lon, y = lat), 
...
gg_change_svalbard <- ggplot() +
  geom_tile(data = subset(svalbard_change, Absolute_diff <= -6), 
            aes(x = lon, y = lat), 
            fill = "#5698c5", width = 1, height = 1) +
  geom_tile(data = subset(svalbard_change, Absolute_diff > -6 & Absolute_diff <= -3), 
            aes(x = lon, y = lat), 
            fill = "#a9cde3", width = 1, height = 1) +
  geom_tile(data = subset(svalbard_change, Absolute_diff > -3 & Absolute_diff <= -0), 
            aes(x = lon, y = lat), 
            fill = "#e0f2fe", width = 1, height = 1) +
  geom_tile(data = subset(svalbard_change, Absolute_diff > 0 & Absolute_diff <= 3), 
            aes(x = lon, y = lat), 
            fill = "#feddcc", width = 1, height = 1) +
  geom_tile(data = subset(svalbard_change, Absolute_diff > 3 & Absolute_diff <= 6), 
            aes(x = lon, y = lat), 
            fill = "#e6795a", width = 1, height = 1) +
  geom_tile(data = subset(svalbard_change, Absolute_diff > 6), 
            aes(x = lon, y = lat), 
...
gg_change_yamal <- ggplot() +
  geom_tile(data = subset(yamal_change, Absolute_diff <= -6), 
            aes(x = lon, y = lat), 
            fill = "#5698c5", width = 1, height = 1) +
  geom_tile(data = subset(yamal_change, Absolute_diff > -6 & Absolute_diff <= -3), 
            aes(x = lon, y = lat), 
            fill = "#a9cde3", width = 1, height = 1) +
  geom_tile(data = subset(yamal_change, Absolute_diff > -3 & Absolute_diff <= -0), 
            aes(x = lon, y = lat), 
            fill = "#e0f2fe", width = 1, height = 1) +
  geom_tile(data = subset(yamal_change, Absolute_diff > 0 & Absolute_diff <= 3), 
            aes(x = lon, y = lat), 
            fill = "#feddcc", width = 1, height = 1) +
  geom_tile(data = subset(yamal_change, Absolute_diff > 3 & Absolute_diff <= 6), 
            aes(x = lon, y = lat), 
            fill = "#e6795a", width = 1, height = 1) +
  geom_tile(data = subset(yamal_change, Absolute_diff > 6), 
            aes(x = lon, y = lat), 
